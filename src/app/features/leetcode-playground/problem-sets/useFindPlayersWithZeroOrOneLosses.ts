...
export const useFindPlayersWithZeroOrOneLosses = (): ProblemSetType => {
    const findPlayersWithZeroOrOneLosses = ({matches}: { matches: [number, number][] }) => {
    ...
    return {
        ...
        problemSetFunction: findPlayersWithZeroOrOneLosses
    }
